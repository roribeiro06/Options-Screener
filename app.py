...
st.caption("Live scan of a broad US-listed universe (not limited to the S&P 500), screened with the "
           ...
           "real dollar volume -- **up-movers** screened for puts only, **down-movers** screened for call "
           "credit spreads only (fading the move, with likely-richer premium from the volatility). Both "
           "pools require at least \\$25M/day in dollar volume (price x volume, not just a share count -- a "
           "cheap stock can clear a share-count bar on trivial real activity) AND a market cap of at least "
           "\\$10B, so thinly-capitalized or speculative names don't surface just because they're liquid or "
           "moved a lot. Every candidate, surge or mover, still needs real open interest to qualify -- none "
           "of the above skips that check. "
