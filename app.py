...
st.caption("Tracked positions you've SOLD to open (puts, covered calls, credit spreads) -- edited in "
           ...
           "the total across Contracts in parentheses -- MaxLoss is the real cash on the line, not a "
           "stock-to-zero worst case (except covered calls, where that genuinely is the worst case): the "
           "full cash-secured collateral (the strike, not netted by premium) for puts, cost basis - "
           "premium for covered calls (needs the ticker in `HOLDINGS`, else undefined), width - credit "
