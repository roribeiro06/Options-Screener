...
st.caption("Tracked positions you've SOLD to open (puts, covered calls, credit spreads) -- edited in "
           ...
           "puts, where it's the loss already incurred: strike - current stock price ($0 while the put is "
           "out of the money, gross of premium). Covered calls: cost basis - premium (needs the ticker in "
