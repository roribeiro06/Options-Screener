"""
sp500_tickers.py -- static snapshot of the S&P 500 constituent list, used as the
candidate universe for build_volume_leaders.py (finding high-options-volume tickers
outside your manually chosen watchlist).

Source: https://en.wikipedia.org/wiki/List_of_S%26P_500_companies
Snapshot date: 2026-08-05. Share classes use Tradier's "/" convention (BRK/B, not BRK.B).

Membership changes over time (additions/removals from S&P Dow Jones Indices).
To refresh, re-pull the constituents table from the Wikipedia URL above and
